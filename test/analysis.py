...
from test.utils.image import make_graphviz_image
from test.utils.analysis_helpers import (
    ReactionTreeFromDict,
    ReactionTreeFromMcts,
    CombinedReactionTrees,
)
from test.utils.route_clustering import ReactionTreeWrapper, ClusteringHelper
...
if TYPE_CHECKING:
    ...
    from test.context.scoring import Scorer
...
class TreeAnalysis:
    ...
    def __init__(self, search_tree: SearchTree, scorer: Scorer = None) -> None:
        ...
        if scorer is None:
            ...
            from test.context.scoring import StateScorer
